...
public class IdempotencyStepDefinitions {
    ...
    public void i_do_not_provide_an_idempotency_key() {
        // TODO: Clear the idempotency key from shared test context
    ...
    public void i_provide_the_same_idempotency_key(String key) {
        // TODO: Store the same idempotency key for a retry request
    ...
    public void i_provide_a_different_idempotency_key(String key) {
        // TODO: Store a different idempotency key
    ...
    public void i_create_the_same_transaction_again_with_the_same_idempotency_key(String key) {
        // TODO: Create the same transaction request again with the stored idempotency key
        // Use transactionData from shared test context and include the Idempotency-Key header
        // Store the response in shared test context for verification
        testContext.setIdempotencyKey(key);
    ...
    public void i_create_the_same_transaction_again_without_an_idempotency_key() {
        // TODO: Create the same transaction request again without idempotency key
    ...
    public void i_store_the_transaction_identifier() {
        // TODO: Extract and store the transaction ID from the response in shared test context
    ...
    public void the_response_should_contain_the_same_transaction_identifier_as_stored() {
        // TODO: Verify that the response contains the same transaction ID as stored
    ...
    public void no_duplicate_transaction_should_be_created_in_the_ledger() {
        // TODO: Verify that only one transaction exists in the ledger for this idempotency key
        // Query the database or GET /transactions endpoint to count transactions
        // Should verify that the stored transaction ID appears only once
    ...
    public void the_request_should_be_rejected_with_a_conflict_error() {
        // TODO: Verify that the response has HTTP 409 Conflict status
    ...
    public void i_should_receive_an_error_message_about_the_idempotency_key_conflict() {
        // TODO: Verify that the error response contains a clear message about the conflict
    ...
    public void the_original_transaction_should_remain_unchanged() {
        // TODO: Verify that the original transaction created with the idempotency key is unchanged
        // Query the ledger to verify the original transaction still exists with its original data
    ...
    public void a_new_transaction_should_be_created_in_the_ledger() {
        // TODO: Verify that a new transaction was created
    ...
    public void the_new_transaction_should_have_a_different_identifier_than_the_stored_one() {
        // TODO: Verify that the new transaction has a different ID than the stored one
